...
private:
  ...
  string m_doNothingFunctionName, m_existsFunctionName;
  ...
  static string sm_prefix, sm_LoadingFunctionName, sm_GLErrorFunctionName, sm_ErrorLoadingFunctionName;
  ...
  static string sm_GLPreErrorFunctionName;
...
public:
  ...
  static 
  void 
  SetPrefix(const string &pre) 
  {
    sm_prefix=pre; 
    sm_LoadingFunctionName=sm_prefix+"_loadFunction";
    sm_GLErrorFunctionName=sm_prefix+"_ErrorCheck";
    sm_GLPreErrorFunctionName=sm_prefix+"_preErrorCheck";
    sm_ErrorLoadingFunctionName=sm_prefix+"_on_load_function_error";
    sm_laodAllFunctionsName=sm_prefix+"_load_all_functions";
    sm_insideBeginEndPairNameCounter=sm_prefix+"_inSideBeginEndPairCounter";
    sm_insideBeginEndPairNameFunction=sm_prefix+"_inSideBeginEndPair";
    sm_kglLoggingStreamNameOnly=sm_prefix+"_LogStream";
