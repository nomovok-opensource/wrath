...
#define USE4CHANNEL_FONT_TEXTURE
...
/*!
  ...
  WRATHTextureFontTTF has two channels.
  
  \n\t (luminance)
       channel 0 = distance value, used for simple discard rendering of fonts,
  ...
  \n\t (alpha)
       channel 1 = blend/opacity value used for blending rendering of fonts 
...
public:
  ...
  */
  ...
  //!\fn
  /*!
    Gets the _HINT_ how wide the next WRATHTextureFontTTF will be,
    the hint is used as follows, the width used is the
    minimum between this hint and GL_MAX_TEXTURE_SIZE,
  ...
  //!\fn
  /*!
    Sets the _HINT_ how wide the next WRATHTextureFontTTF will be,
    the hint is used as follows, the width used is the
    minimum between this hint and GL_MAX_TEXTURE_SIZE,
    default value is 1024. Strongly advised to use powers
    of 2 for this value.
   */
  static
  void
  ...
  /*!
    ...
    of the WRATHTextureFontTTF that are "allocated"
    but not used to store to store pixels of any glyphs.
   */
  int
...
private:
  ...
  typedef vecN<uint8_t,2> pixel_type; 
